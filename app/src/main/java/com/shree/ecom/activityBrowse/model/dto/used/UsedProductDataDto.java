...
public class UsedProductDataDto implements Serializable {
    @Expose
    @SerializedName("imgs")
    private List<UsedProductImgsDto> imgs;
    @Expose
    @SerializedName("img")
    private String img;
    @Expose
    ...
    public List<UsedProductImgsDto> getImgs() {
        return imgs;
    }

    public void setImgs(List<UsedProductImgsDto> imgs) {
        this.imgs = imgs;
    }
